...
// teto configurado), nunca derrubar a rota.
// Tipo solto de propósito (mesmo padrão já usado no resto do arquivo, ex.:
// `let p: any` em handleIngestAiUsage) — settings é um blob JSON heterogêneo.
