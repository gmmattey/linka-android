        ...
        {onSearchChange ? (
          <>
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 text-xs rounded-xl transition-colors focus:outline-none"
              style={{
      ...
      <div className="flex flex-wrap items-center gap-3.5">
        ...
        {onRefresh && (
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-2 text-xs rounded-xl transition-colors cursor-pointer disabled:opacity-50"
            style={{
              backgroundColor: "var(--sq-bg-card)",
              border: "1px solid var(--sq-border)",
              color: "var(--sq-text-secondary)",
        ...
        {onExport && (
          <button
            onClick={onExport}
            className="flex items-center gap-1.5 px-4 py-2 text-xs font-semibold rounded-xl transition-colors cursor-pointer"
            style={{
              backgroundColor: "var(--sq-bg-card)",
              border: "1px solid var(--sq-border)",
              color: "var(--sq-text-secondary)",
