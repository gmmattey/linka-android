...
/**
 * Agrega os dados ja persistidos da visita (cliente, ambientes, medicoes, diagnosticos,
 * evidencias) num unico [LaudoDados] para a tela 3.2. Extraido de [LaudoViewModel] para nao
 * concentrar 7 repositorios no construtor do ViewModel (detekt `LongParameterList`) e para
 * isolar a orquestracao de montagem do laudo, no mesmo espirito de
