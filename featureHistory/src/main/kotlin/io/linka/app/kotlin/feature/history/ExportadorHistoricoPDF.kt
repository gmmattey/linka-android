...
<body>
  <div class="header">
    <h1>Relatório de Medições — Linka</h1>
...
${if (medicoes.isEmpty()) "      <tr><td colspan=\"5\" class=\"empty\">Nenhuma medição registrada.</td></tr>" else linhasHtml}
  ...
  <div class="footer">
    Linka — monitoramento inteligente de rede &nbsp;|&nbsp; Relatório gerado automaticamente
  </div>
</body>
</html>"""
    }
    ...
    private fun desenharCabecalho(
        ...
        canvas.drawText("Relatório de Medições — Linka", MARGEM, y, paintTitulo)
        y += 6f
    ...
    private fun desenharRodape(canvas: android.graphics.Canvas, totalMedicoes: Int) {
        ...
        canvas.drawText(
            "Linka — monitoramento inteligente de rede  |  $totalMedicoes medições exportadas",
            MARGEM,
            yRodape,
            paintRodape,
        )
