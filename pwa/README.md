...
Em desenvolvimento. Acompanhe no Linear pelo projeto `SignallQ` com issues marcadas como `area:pwa` (ou equivalente).
...
A definir quando o projeto for inicializado.
