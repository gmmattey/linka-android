...
| **DIAGNÓSTICO** | Envolve engines, DNS, Wi-Fi, speedtest, IA | Cláudio + /diagnostic-engine → /regras-dispositivos-android (se crítico) → Camilo |
...
4. **`/regras-dispositivos-android`** — se a task Android tocar permissão, Wi-Fi, DNS, background ou OEM, invocar **antes do Camilo**.
   `[Invocando /regras-dispositivos-android — task toca [domínio crítico], validação obrigatória antes de Camilo]`
...
- [ ] Task toca permissão, Wi-Fi, DNS, background service? → `/regras-dispositivos-android` obrigatório.
