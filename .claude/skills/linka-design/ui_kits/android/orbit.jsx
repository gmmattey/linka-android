/* Linka UI Kit — Orbit (IA conversacional). Always-dark surface. */
  ...
  return (
    <div style={{ flex:1, display:'flex', flexDirection:'column', background:ORB.bg }}>
      ...
      <div style={{ display:'flex', alignItems:'center', gap:12, padding:'14px 16px',
        ...
        <div>
          <div style={{ font:`600 15px/1.2 ${LK.font}`, color:ORB.text }}>Orbit</div>
      ...
      <div ref={scroller} style={{ flex:1, overflowY:'auto', padding:16, display:'flex',
        ...
        <div style={{ font:`400 12px/1.5 ${LK.font}`, color:ORB.sub, textAlign:'center', padding:'4px 20px' }}>
          O Orbit analisa seus dados no aparelho. Nada sai do seu celular.</div>
...
Object.assign(window, { OrbitScreen, ORB });
