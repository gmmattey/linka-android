...
class AiDiagnosisRepository(
    ...
    private fun parseModeloIa(obj: JSONObject?): ModeloIa {
        ...
        return ModeloIa(
            ...
            nomeExibicao = obj.optString("nomeExibicao", "Linka IA").ifBlank { "Linka IA" },
            nomeCompletoComercial = obj.optString("nomeCompletoComercial", "Linka IA").ifBlank { "Linka IA" },
            descricaoComercial = obj.optString("descricaoComercial", ""),
            textoRodape = obj.optString("textoRodape", "Motor de análise: Linka IA")
                .ifBlank { "Motor de análise: Linka IA" },
        )
    }
