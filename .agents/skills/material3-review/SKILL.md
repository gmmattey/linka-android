...
Tokens oficiais: `.Codex/skills/linka-design/colors_and_type.css` e `SignallQTheme.kt`.
Tabela de equivalência CSS → Compose: `.Codex/skills/linka-design/HANDOFF_README.md`.
Componentes de referência: `.Codex/skills/linka-design/ui_kits/android/`.
